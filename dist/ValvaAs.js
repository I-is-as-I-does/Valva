(function (global, factory) {
    ...
    function easeOut(elm, duration = deflt.duration, callback = null, timing = deflt.timing) {
        vHide(elm, 'ease', duration, callback, timing);
    }
    function easeIn(elm, duration = deflt.duration, callback = null, timing = deflt.timing) {
        vShow(elm, 'ease', duration, callback, timing);
    }
    function easeToggle(elm, duration = deflt.duration, callback = null, timing = deflt.timing) {
        vToggle(elm, 'ease', duration, callback, timing);
    }
    function timedEaseToggle(elm, delay = deflt.delay, duration = deflt.duration, callback = null, timing = deflt.timing) {
        vTempToggle(elm, 'ease', delay, duration, callback, timing);
    }



    function slideUp(elm, duration = deflt.duration, callback = null, timing = deflt.timing) {
        vHide(elm, 'slide', duration, callback, timing);
    }
    function slideDown(elm, duration = deflt.duration, callback = null, timing = deflt.timing) {
        vShow(elm, 'slide', duration, callback, timing);
    }
    function slideToggle(elm, duration = deflt.duration, callback = null, timing = deflt.timing) {
        vToggle(elm, 'slide', duration, callback, timing);
    }
    function timedSlideToggle(elm, delay = deflt.delay, duration = deflt.duration, callback = null, timing = deflt.timing) {
        vTempToggle(elm, 'slide', delay, duration, callback, timing);
    }



    function fadeOut(elm, callback = null, duration = deflt.duration, timing = deflt.timing) {
        vHide(elm, 'fade', duration, callback, timing);
    }
    function fadeIn(elm, callback = null, duration = deflt.duration, timing = deflt.timing) {
        vShow(elm, 'fade', duration, callback, timing);
    }
    function fadeToggle(elm, callback = null, duration = deflt.duration, timing = deflt.timing) {
        vToggle(elm, 'fade', duration, callback, timing);
    }
    function timedFadeToggle(elm, delay = deflt.delay, callback = null, duration = deflt.duration, timing = deflt.timing) {
        vTempToggle(elm, 'fade', delay, duration, callback, timing);
    }


    function diversionToggle(elm, callback = null, ease = true, duration = deflt.duration, reverse = false, timing = deflt.timing) {
        var t = ease ? 'ease' : 'slide';
        vToggleResolve(elm, callback, t, duration, timing, reverse);
    }

    function insertDiversion(parent, child, prepend = false, ease = true, duration = deflt.duration, callback = null, timing = deflt.timing) {
        var t = ease ? 'ease' : 'slide';
        vPlace(parent, child, prepend, t, duration, callback, timing);
    }

    function replaceDiversion(oldElm, newElm, callback, duration = deflt.duration, timing = deflt.timing) {
        vReplace(oldElm, newElm, duration, callback, timing);
    }

    function splitFlap(elm, text, speed = deflt.speed) {
        vSplitFlap(elm, text, speed);
    }

    exports.diversionToggle = diversionToggle;
    exports.easeIn = easeIn;
    exports.easeOut = easeOut;
    exports.easeToggle = easeToggle;
    exports.fadeIn = fadeIn;
    exports.fadeOut = fadeOut;
    exports.fadeToggle = fadeToggle;
    exports.insertDiversion = insertDiversion;
    exports.replaceDiversion = replaceDiversion;
    exports.slideDown = slideDown;
    exports.slideToggle = slideToggle;
    exports.slideUp = slideUp;
    exports.splitFlap = splitFlap;
    exports.timedEaseToggle = timedEaseToggle;
    exports.timedFadeToggle = timedFadeToggle;
    exports.timedSlideToggle = timedSlideToggle;
    exports.vHide = vHide;
